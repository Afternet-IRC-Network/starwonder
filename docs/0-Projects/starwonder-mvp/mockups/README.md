...
- **Pros:** cheapest to build (it's just text + CSS), ultra-light, scales to any screen,
  leans hardest into the TW2002 heritage, trivially themeable (amber/green/ice).
...
> TW2002's exact screens, names, or art. The procedural engine helps — our planets are
